...
@Service
public class EntrepreneurApplicationListByTicketService implements AbstractListService<Entrepreneur, Application> {
	...
	public Collection<Application> findMany(final Request<Application> request) {
		...
		applist = this.repository.findMyAllByTicket(id);
