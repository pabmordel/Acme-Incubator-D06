...
@Service
public class AuthenticatedToolRecordListBySectorService implements AbstractListService<Authenticated, ToolRecord> {
	...
	public Collection<ToolRecord> findMany(final Request<ToolRecord> request) {
		...
		toollist = this.repository.findManyBySector();
